...
from customers import get_all_customers, get_single_customer, create_customer, delete_customer, update_customer, get_all_customers, get_customers_by_email
...
# The above is where I am filtering between what the response is asking
    # Here's a method on the class that overrides the parent's method.
